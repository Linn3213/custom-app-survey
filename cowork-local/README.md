...
The suite covers the shell-command classifier, the file/shell tools and their
workspace confinement, the approval policy, the event bus (including history
replay), and the HTTP API (auth, endpoints). CI runs lint + tests on Python
